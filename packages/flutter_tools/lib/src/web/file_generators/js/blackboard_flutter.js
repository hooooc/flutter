...
(function () {
  ...
  class FlutterServiceWorkerLoader {
    ...
    loadServiceWorker(settings) {
      ...
      var serviceWorkerName = "flutter_service_worker.js";
      if (cdnBase) {
        serviceWorkerName = "blackboard_service_worker.js"
      }
      const {
        serviceWorkerVersion,
        serviceWorkerUrl = `${baseUri}${serviceWorkerName}?v=${serviceWorkerVersion}`,
        timeoutMillis = 4000,
      } = settings;
  ...
  class FlutterEntrypointLoader {
    ...
    async loadEntrypoint(options) {
      const { entrypointUrl = `${assetBase}${baseUri}main.dart.js`, onEntrypointLoaded } =
        options || {};
